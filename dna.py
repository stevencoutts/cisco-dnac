...
class Dnac(requests.Session):
    ...
    def request(self, method: str, api: str, ver: str = 'api/v1',
                data: Optional[Dict[str, Any]] = None, **kwargs: Any) -> JsonObj:
    ...
    def wait_on_task(self, task_id: str, timeout: float = 125,
                    interval: float = 2, backoff: float = 1.15) -> JsonObj:
        ...
        while True:
            ...
            logging.info(f'TASK {task_id} has not completed yet. Sleeping {int(interval)} seconds')
...
def find(obj: Union[List[Any], JsonObj], val: Any, key: str = 'id') -> Optional[JsonObj]:
